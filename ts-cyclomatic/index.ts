// taken from https://dev.to/josethz00/measuring-your-code-complexity-21jp
...
const tmpSourceFile = ts.createSourceFile('tmp.ts', fileContent, ts.ScriptTarget.Latest, true)
